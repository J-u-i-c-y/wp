...
wp_enqueue_script('archive-pagination-js', get_template_directory_uri() . '/assets/js/archive-pagination.js');
...
wp_enqueue_style('fontawesome-css', get_template_directory_uri() . '/page-templates/company-template/assets/css/fontawesome.css');
